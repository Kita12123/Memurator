...
from flaskr.common import db
from ProgramData import PROGRAM_DIR
from ProgramFiles.flaskr.common.db import sync
from ProgramFiles.flaskr.common.df import arrage_df
from ProgramFiles.flaskr.common.system import system
from ProgramFiles.flaskr.common.req import req
...
def index():
    user = cont.index.load(id=request.remote_addr)
